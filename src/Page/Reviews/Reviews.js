      ...
      <section className="my-8 dark:bg-gray-800 dark:text-gray-100">
        <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
          ...
          <p className="px-6 py-2 text-2xl font-semibold text-center sm:font-bold sm:text-3xl md:text-4xl lg:max-w-2xl xl:max-w-4xl dark:text-gray-300">
            "The best introduction for beginners into the field of data science
            and coding. Super easy to get in, very flexible too and amazingly
            efficient. Price-Benefit ratio is top in the market. I couldn't find
            an easier and better tool."
          </p>
          <div className="flex justify-center space-x-3">
            ...
            <div className="flex justify-center items-center">
              <div>
                <p className="leading-tight">Hasan Chowdhury</p>
